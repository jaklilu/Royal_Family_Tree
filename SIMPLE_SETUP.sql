-- SIMPLE SETUP - Run this entire script at once
-- This creates tables WITHOUT constraints first, then adds them
...
-- 2. Create relationships table (simple, no constraints yet)
...
-- 3. Now add constraints (tables exist, so this will work)
DO $$ 
BEGIN
